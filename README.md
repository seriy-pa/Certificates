...
## 2. Курс Python Advanced ["Twitter-clone"](https://github.com/seriy-pa/python_advanced_diploma)
   * Итоговый проект Python Advanced   [Просмотреть >>](https://github.com/seriy-pa/python_advanced_diploma)
   * Сертификат о прохождении курса Python Advanced   [Просмотреть >>](images/Python_Advanced.md)

## 3. Курс Python фреймворк Django ["Интернет-магазин"](https://github.com/seriy-pa/python_django_diploma)
   * Итоговый проект Python фреймворк Django   [Просмотреть >>](https://github.com/seriy-pa/python_django_diploma)
   * Сертификат о прохождении курса Python фреймворк Django   [Просмотреть >>](images/Python_Framework_Django.md)

## 4. Профессия Python-разработчик
   * Сертификат о прохождении курса Python-разработчик   [Просмотреть >>](images/developer.md)
